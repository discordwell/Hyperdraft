...
# Slice-13 retrofit tests removed: those tested the median-lift stubs which
# emitted generic SCRY/SURVEIL/LIFE_CHANGE noise instead of the cards real
# rules text. The stubs are gone; the per-card tests live in
# tests/test_man_of_pider_interceptors.py.
