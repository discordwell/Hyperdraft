...
class Game:
    ...
    def __init__(
        ...
        *,
        ...
        clear_damage_on_cleanup: Optional[bool] = None,
    ):
        ...
        if clear_damage_on_cleanup is not None:
            self.state.clear_damage_on_cleanup = clear_damage_on_cleanup
    ...
    def _check_sbas_once(self) -> list[Event]:
        ...
        if self.state.game_mode == "minecraft":
            ...
            from .scp import check_scp_win
            events.extend(check_scp_win(self))
        else:
