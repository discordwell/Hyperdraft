...
const SCP2GameView = lazy(() => import('./pages/SCP2GameView').then(m => ({ default: m.SCP2GameView })));
    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<LoadingFallback />}>
        <Routes>
          ...
          <Route path="/scp2" element={<SCP2GameView />} />
          <Route path="/game/:matchId/scp2" element={<SCP2GameView />} />
        </Routes>
      </Suspense>
    </BrowserRouter>
  );
